          ...
          <div className="md:justify-self-end md:text-right">
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-start md:justify-end">
                <svg className="w-5 h-5 mr-2 mt-0.5 flex-shrink-0 md:order-2 md:mr-0 md:ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <a 
                  href="https://www.google.com/maps/place/Calz.+H%C3%A9ctor+Agusto+Espa%C3%B1a+Bracamonte,+Chiquimula/@14.8068801,-89.5379117,17z" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-white transition"
                >
                  Calz. Héctor Agusto España Bracamonte,<br/>Chiquimula, Guatemala
                </a>
              </li>
              <li className="flex items-center md:justify-end">
                <svg className="w-5 h-5 mr-2 flex-shrink-0 md:order-2 md:mr-0 md:ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@aquaequipos.com" className="hover:text-white transition">
                  info@aquaequipos.com
                </a>
              </li>
              <li className="flex items-center md:justify-end">
                <svg className="w-5 h-5 mr-2 flex-shrink-0 md:order-2 md:mr-0 md:ml-2" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://wa.me/50244349387" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
                  +502 4434-9387
                </a>
              </li>
            </ul>
